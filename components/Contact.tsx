    ...
    <section id="contact" className="py-24 bg-slate-900 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            <h2 className="text-base font-semibold text-nova-400 tracking-wide uppercase">Get In Touch</h2>
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                <div className="flex-shrink-0">
                  <div className="w-12 h-12 bg-slate-800 rounded-lg flex items-center justify-center text-nova-400">
          ...
          <div className="relative h-96 lg:h-auto w-full bg-slate-800 rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
            ...
            <div className="absolute bottom-4 right-4 bg-slate-900/90 backdrop-blur px-4 py-2 rounded-lg border border-white/10 text-xs text-white">
                TechNova Campus
            </div>
          </div>
